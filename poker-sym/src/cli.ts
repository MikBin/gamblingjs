...
program
  .name('poker-sym')
  .description('Monte Carlo simulation for poker starting hand ranking (Hold\'em, Omaha, Stud Hi/Lo)')
  .version('0.1.0')
  .option('-g, --game <type>', 'game variant: holdem, omaha, stud-hi-lo', 'holdem')
  ...
  .action(async (options) => {
    ...
    const config: SimulationConfig = {
      runs: ((game === 'omaha' || game === 'stud-hi-lo') && isDefaultRuns) ? 1000 : parseInt(runsOption, 10),
