import { bfBestOfFiveOnXindexed, handOfFiveEvalLowBall27Indexed, handOfFiveEvalLow_Ato5Indexed, handOfFiveEvalLow_Ato6Indexed, handOfFiveEvalHiLow9Indexed, handOfFiveEvalHiLow8Indexed, bestFiveOnXHiLowIndexed, getHandInfo5onX, } from './pokerEvaluator5';
/** @function handOfSixEvalIndexed
 *
 * @param {Array:Number[]} array of 6 cards making up an hand
 * @returns {Number} hand ranking ( the best one on all combinations of input card in group of 5)
 */
export const handOfSixEvalIndexed = (...hand) => {
 ...
 * @returns {Number} hand ranking ( the best one on all combinations of input card in group of 5)
 */
export const handOfSixEvalLowBall27Indexed = (...hand) => {
 ...
 * @returns {Number} hand ranking ( the best one on all combinations of input card in group of 5)
 */
export const handOfSixEvalAto5Indexed = (...hand) => {
 ...
 * @returns {Number} hand ranking ( the best one on all combinations of input card in group of 5)
 */
export const handOfSixEvalAto6Indexed = (...hand) => {
 ...
 */
export const handOfSixEvalHiLow8Indexed = (...hand) => {
 ...
 * @returns {hiLowRank} hand ranking ( the best one on all combinations of input card in group of 5)
 */
export const handOfSixEvalHiLow9Indexed = (...hand) => {
 ...
 */
export const _handOfSixEvalIndexed_Verbose = (hand) => {
 ...
 * @returns {verboseHandInfo} hand info about the winning subgroup of 5 cards
 */
export const _handOfSixEvalLowBall27Indexed_Verbose = (hand) => {
 ...
 * @returns {verboseHandInfo} hand info about the winning subgroup of 5 cards
 */
export const _handOfSixEvalAto5Indexed_Verbose = (hand) => {
 ...
 * @returns {verboseHandInfo} hand info about the winning subgroup of 5 cards
 */
export const _handOfSixEvalAto6Indexed_Verbose = (hand) => {
 ...
 * @returns {verboseHandInfo} hand info about the winning subgroup of 5 cards
 */
export const _handOfSixEvalLow8_Verbose = (hand) => {
 ...
 * @returns {verboseHandInfo} hand info about the winning subgroup of 5 cards
 */
export const _handOfSixEvalLow9_Verbose = (hand) => {
