import { createRankOf5On7Hashes, createRankOf7AceToSix_Low, createRankOf7AceToFive_Low, } from './hashesCreator';
import { HASHES_OF_FIVE, HASHES_OF_FIVE_LOW8, HASHES_OF_FIVE_LOW9, HASHES_OF_FIVE_LOW_Ato5, HASHES_OF_FIVE_Ato6, } from './pokerHashes5';
 ...
 */
export const FAST_HASH_DEFINED = {
    high: false,
    Ato5: false,
    Ato6: false,
    '2to7': false,
...
export const fastHashesCreators = {
    high: () => {
        subAssignHashesSeven(HASHES_OF_FIVE_ON_SEVEN, createRankOf5On7Hashes(HASHES_OF_FIVE));
        FAST_HASH_DEFINED.high = true;
    },
    Ato5: () => {
        subAssignHashesSeven(HASHES_OF_SEVEN_LOW_Ato5, createRankOf7AceToFive_Low(HASHES_OF_FIVE_LOW_Ato5, rankCards_low, true));
        FAST_HASH_DEFINED.Ato5 = true;
    },
    Ato6: () => {
        subAssignHashesSeven(HASHES_OF_SEVEN_LOW_Ato6, createRankOf7AceToSix_Low(HASHES_OF_FIVE_Ato6, rankCards_low));
