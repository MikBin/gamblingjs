...
*/
        //@ts-ignore
        var flushRankKey = ((c1 & constants_1.FLUSH_MASK) == flush_check_key) * c1;
        //@ts-ignore
        flushRankKey += ((c2 & constants_1.FLUSH_MASK) == flush_check_key) * c2;
        //@ts-ignore
        flushRankKey += ((c3 & constants_1.FLUSH_MASK) == flush_check_key) * c3;
        //@ts-ignore
        flushRankKey += ((c4 & constants_1.FLUSH_MASK) == flush_check_key) * c4;
        //@ts-ignore
        flushRankKey += ((c5 & constants_1.FLUSH_MASK) == flush_check_key) * c5;
        //@ts-ignore
        flushRankKey += ((c6 & constants_1.FLUSH_MASK) == flush_check_key) * c6;
        //@ts-ignore
        flushRankKey += ((c7 & constants_1.FLUSH_MASK) == flush_check_key) * c7;
        //@ts-ignore
