...
describe('testing rank of 5 and 7 hashes creator', () => {
  ...
  it('has 7462 hands', () => {
    ...
    expect(HASHES_OF_FIVE.rankingInfos.length).toBe(7463);
  });

  it('have highest rank 7452', () => {
    let m = 0;
  ...
  it('has highest rank in fluses 7462', () => {
    let m = 0;
  ...
  it('has 7462 hands too', () => {
    ...
    expect(HASHES_OF_FIVE_ON_SEVEN.rankingInfos.length).toBe(7463);
  });
